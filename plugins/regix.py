...
async def edit(msg, title, status, sts):
   ...
   text = TEXT.format(i.fetched, i.total_files, i.duplicate, i.deleted, i.skip, status, percentage, progress)
   if status in ["cancelled", "completed"]:
       button.append(
         [InlineKeyboardButton('📢 Updates', url='https://t.me/unreal_x_bot'),
         InlineKeyboardButton('💬 Support', url='https://t.me/unreal_x_support')]
         )
   else:
